// Pure Server-Side Rendering - NO CLIENT-SIDE JAVASCRIPT
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        {/* Pure HTML Form - Server-Side Only */}
        <form className="mt-8 space-y-6" action="/api/auth/callback/credentials" method="POST">
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              <input
                ...
                defaultValue="admin@jwscheduler.local"
              />
            </div>
            <div>
              <input
          ...
          <div className="text-center text-sm text-gray-600">
            ...
            <p>Email: admin@jwscheduler.local</p>
